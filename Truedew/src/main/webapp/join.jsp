				...
				<form action="JoinService2" method="post">
					<table id="Join2" style="width: 550px; height: 430px;">
					 <tbody>
						   ...
						   <tr>
							 <td style=" color:white;"><input id ="pw" name="user_pw" class="booking_input booking_input_b" type="password"  placeholder="비밀번호" autofocusmaxlength="20" style="width:400px;height:60px;font-size:15px;"></td>
						   </tr>
