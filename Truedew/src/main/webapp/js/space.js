	function categoryChange(e) {
		var lolist_seoul = ["강북청년창업마루", "서울청년센터 성동오랑", "서울청년센터 광진오랑", "마포오랑","동대문오랑","서울 관악 오랑 청년문화공간","서울청년센터 서초 오랑","서울청년센터 노원오랑","서울청년센터강동오랑","서울청년센터은평오랑","서울청년센터금천오랑"];
		var lolist_incheon = ["인천청년센터 서구1939", "인천 청년공간 유유기지"];
		var lolist_gyeonggi = ["의정부시 청년센터청년공감터", "연천군청년센터 ","청년스테이션","양주시청년센터"];
		var lolist_daegu = ["동구청년센터 the꿈", "수성구청년센터", "대구광역시청년센터공감그래", "대구청년센터다온나그래", "대구광역시청년센터활동그래"];
